...
- `test_inputs/b3b4_intersection_aa.json` -> Ausgabe: `aa`. Schnitt enthaelt das Wort "aa".
- `test_inputs/b3b4_intersection_empty.json` -> Ausgabe: `⊥`. Schnitt ist leer.
- `test_inputs/b3b4_intersection_epsilon.json` -> Ausgabe: `ε`. Beide akzeptieren ε.
- `test_inputs/b3b4_intersection_is_epsilon.json` -> Ausgabe: `ε`. Schnitt enthaelt ε.
- `test_inputs/b3b4_inclusion_subset.json` -> Ausgabe: `ab`. Schnitt enthaelt "ab".
- `test_inputs/b3b4_inclusion_counterexample.json` -> Ausgabe: `⊥`. Schnitt ist leer.
- `test_inputs/b3b4_inclusion_epsilon.json` -> Ausgabe: `⊥`. Schnitt ist leer.
